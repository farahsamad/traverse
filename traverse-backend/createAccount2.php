...
if(isset($_POST['name']) && isset($_POST['birthday']) && isset($_POST['nationality']) && isset($_POST['gender']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['password'])){                    
    ...
    if(empty($_POST['name'])){                                               
        ...
        if($age < 14){
            ...
            $email=$_POST['email'];
            $phone=$_POST['phone'];
            $insert="INSERT INTO `user`(`username`, `password`, `name`, `phone`, `email`, `date_of_birth`, `nationality`, `user_type`, `accounr_type`, `gender`, `profile`) VALUES ('$username','$password','$name','$phone','$email','$birthday','$nationality','0','0','$gender','Capture.png')";
